...
seu retorno em uma variável temporária \proc{temp}. Assim, o erro relativo naquela iteração foi $(\proc{temp} - i) / i$, 
...
\texttt{MorrisPlus}. O esperado é que vejamos a \proc{Lei dos Grandes Números} em ação e que a variância do Programa
