...
armazenamos seu retorno em um variável temporária \proc{temp}. Assim, o erro relativo nesta iteração era 
$(\proc{temp} - i) / i$, uma vez que, $i$ pode ser visto como a quantidade de itens já inseridos na estrutura, ou o 
total de elementos do conjunto~$\Mbb$ já processados se lembrarmos do Algoritmo $\Morris$.
