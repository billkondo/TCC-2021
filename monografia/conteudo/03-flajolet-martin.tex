...
Então, além do erro padrão, existe também o viés do Algoritmo da \proc{Contagem Probabilística}, cujo valor é $1 + 0{,}31/m$. Contudo, para 
...
\begin{figure}
  \centering
  \subfloat[\centering Evolução da estimativa $(m=64)$]
  {{\includegraphics[width=7cm]{figuras/probabilistic_counting_m_64_first.png} }}
  \qquad
  \subfloat[\centering Evolução do erro relativo $(m=64)$]
  {{\includegraphics[width=7cm]{figuras/probabilistic_counting_erro_m_64_first.png} }}
...
A precisão da $\pcounting$, portanto, pode ser melhorada se aumentarmos o valor de $m$, mas essa ideia não se aplica 
