...
prefixo da representação binária de um inteiro. Podemos, portanto, aproveitar o método $p$ da classe 
...
custo é o mesmo que o do algoritmo~$\pcounting$ quando $L = 32$. Dessa forma, as $\asampling$, que têm um desvio maior
que a $\pcounting$, têm também um consumo de espaço pior. 
