...
% Adiciona comando \twodots
\usepackage{clrscode3e}

\usepackage{chngcntr}
% Adiciona numeração contínua a figuras
\counterwithout{figure}{chapter}
% Adiciona numeração contínua a equações
...
\newcommand{\Pbb}{\mathbb{Pr}}
\newcommand{\Cov}{\mathbb{Cov}}
\newcommand{\Morris}{\proc{Morris}}
\newcommand{\Morrispp}{\proc{Morris++}}

% Pseudocódigos
\renewcommand{\For}{\textbf{para\ }}
\renewcommand{\While}{\textbf{enquanto\ }}
\renewcommand{\To}{\textbf{até\ }}
\renewcommand{\If}{\textbf{se\ }}
\renewcommand{\Return}{\textbf{devolva\ }}
...
% Amostragens Adaptativas
\newcommand{\asampling}{\proc{Amostragens Adaptativas}}
\newcommand{\AS}{\textsf{AdaptiveSampling}}
...
% Remove espaços à esquerda do símbolo de raiz quadrada
